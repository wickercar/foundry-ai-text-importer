...
export const genParsed5eItemFromBasicItem = async (basicItem: Parsed5eMonsterBasicItem): Promise<Parsed5eItem> => {
  ...
  return Parsed5eItemParser.fromScratch(basicItem);
};
